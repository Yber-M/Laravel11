...
return [
    ...
    'min' => [
        'numeric' => 'El valor del campo ":attribute" debe ser al menos de :min.',
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí puede especificar mensajes de validación personalizados para atributos usando la convención
    | "attribute.rule" para nombrar las líneas. Esto hace que sea rápido especificar una línea personalizada
    ...
    */
    ...
    | con algo más fácil de leer, como "Dirección de correo electrónico" en lugar de "correo electrónico".
